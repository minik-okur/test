...
const HIKAYE_SVGS = {
  1: {
    /* Sahne 0 — Mina kırmızı oyuncak arabasını aldı */
    0: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 220"><defs><linearGradient id="h1bg0" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#FFF9F0"/><stop offset="100%" stop-color="#FFE0CC"/></linearGradient></defs><rect width="400" height="220" fill="url(#h1bg0)"/><!-- Zemin --><rect x="0" y="185" width="400" height="35" fill="#F5C9A0"/><!-- Oyun odası zemini --><rect x="0" y="182" width="400" height="5" fill="#E8A87C"/><!-- Duvar süsü --><circle cx="50" cy="60" r="18" fill="#FFD6E0" opacity="0.5"/><circle cx="360" cy="80" r="14" fill="#D6E8FF" opacity="0.5"/><text x="38" y="67" font-size="14" fill="#FF85A1" opacity="0.7">★</text><!-- Raf --><rect x="30" y="95" width="100" height="8" fill="#D4A96A" rx="2"/><rect x="35" y="76" width="18" height="20" fill="#FF5252" rx="2"/><rect x="56" y="79" width="15" height="17" fill="#448AFF" rx="2"/><rect x="74" y="74" width="20" height="22" fill="#69F0AE" rx="2"/><!-- Mina — sevimli kız karakter --><g transform="translate(220,60)"><!-- Gövde / elbise --><ellipse cx="0" cy="95" rx="28" ry="34" fill="#FF85A1"/><!-- Etek dalgası --><ellipse cx="0" cy="122" rx="30" ry="10" fill="#FF4081" opacity="0.4"/><!-- Kol sol --><rect x="-38" y="78" width="12" height="26" fill="#FDBCB4" rx="6" transform="rotate(-15,-32,91)"/><!-- Kol sağ — arabayı tutuyor --><rect x="26" y="82" width="12" height="22" fill="#FDBCB4" rx="6" transform="rotate(20,32,93)"/><!-- Bacaklar --><rect x="-16" y="127" width="11" height="28" fill="#FDBCB4" rx="5"/><rect x="5" y="127" width="11" height="28" fill="#FDBCB4" rx="5"/><!-- Ayakkabılar --><ellipse cx="-10" cy="157" rx="11" ry="5" fill="#FF4081"/><ellipse cx="11" cy="157" rx="11" ry="5" fill="#FF4081"/><!-- Yüz --><circle cx="0" cy="48" r="26" fill="#FDBCB4"/><!-- Saç — uzun koyu --><path d="M-22 38 Q-26 70 -22 100" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><!-- Sol saç --><path d="M22 38 Q26 70 22 100" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><!-- Sağ saç --><path d="M-22 36 Q0 22 22 36" fill="#3D1F0A"/><!-- Üst saç --><path d="M-22 38 Q0 26 22 38 Q18 60 0 62 Q-18 60 -22 38Z" fill="#4A2C0A"/><!-- Saç tokası sol --><circle cx="-20" cy="52" r="5" fill="#FF4081"/><circle cx="-20" cy="52" r="2.5" fill="#FFD6E0"/><!-- Saç tokası sağ --><circle cx="20" cy="52" r="5" fill="#FF4081"/><circle cx="20" cy="52" r="2.5" fill="#FFD6E0"/><!-- Gözler --><ellipse cx="-9" cy="46" rx="5" ry="6" fill="#2C1810"/><!-- Sol göz --><ellipse cx="9" cy="46" rx="5" ry="6" fill="#2C1810"/><!-- Sağ göz --><circle cx="-7" cy="44" r="2" fill="white"/><circle cx="11" cy="44" r="2" fill="white"/><!-- Parıltı --><ellipse cx="-9" cy="52" rx="3" ry="2" fill="#FF9AA2" opacity="0.5"/><!-- Alt göz gölgesi --><ellipse cx="9" cy="52" rx="3" ry="2" fill="#FF9AA2" opacity="0.5"/><!-- Yanaklar --><circle cx="-15" cy="57" r="7" fill="#FFB3BA" opacity="0.6"/><!-- Sol yanak --><circle cx="15" cy="57" r="7" fill="#FFB3BA" opacity="0.6"/><!-- Sağ yanak --><!-- Gülümseme --><path d="M-7 63 Q0 70 7 63" fill="none" stroke="#C0605A" stroke-width="2.5" stroke-linecap="round"/><!-- Burun --><circle cx="0" cy="57" r="2" fill="#E8927C" opacity="0.6"/></g><!-- Kırmızı oyuncak araba —  Mina'nın elinde --><g transform="translate(268,152)"><!-- Araba gövdesi --><rect x="-34" y="-14" width="68" height="26" fill="#FF3D00" rx="8"/><!-- Kabin --><rect x="-20" y="-26" width="40" height="16" fill="#FF6E40" rx="5"/><!-- Camlar --><rect x="-16" y="-24" width="14" height="10" fill="#B3E5FC" rx="2" opacity="0.9"/><!-- Sol cam --><rect x="2" y="-24" width="14" height="10" fill="#B3E5FC" rx="2" opacity="0.9"/><!-- Sağ cam --><!-- Tekerlekler --><circle cx="-20" cy="14" r="11" fill="#212121"/><circle cx="-20" cy="14" r="5" fill="#616161"/><circle cx="20" cy="14" r="11" fill="#212121"/><circle cx="20" cy="14" r="5" fill="#616161"/><!-- Far --><ellipse cx="32" cy="-2" rx="5" ry="4" fill="#FFD740" opacity="0.9"/><!-- Parlak çizgi --><rect x="-28" y="-6" width="56" height="3" fill="rgba(255,255,255,0.25)" rx="1"/></g></svg>`,

    /* Sahne 1 — Arabayı yere koydu ve hafifçe itti */
    1: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 220"><defs><linearGradient id="h1bg1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#FFF9F0"/><stop offset="100%" stop-color="#FFE0CC"/></linearGradient></defs><rect width="400" height="220" fill="url(#h1bg1)"/><rect x="0" y="185" width="400" height="35" fill="#F5C9A0"/><rect x="0" y="182" width="400" height="5" fill="#E8A87C"/><!-- Raf --><rect x="30" y="95" width="100" height="8" fill="#D4A96A" rx="2"/><rect x="35" y="76" width="18" height="20" fill="#FF5252" rx="2"/><rect x="56" y="79" width="15" height="17" fill="#448AFF" rx="2"/><rect x="74" y="74" width="20" height="22" fill="#69F0AE" rx="2"/><!-- Mina eğilmiş arabayı itiyor --><g transform="translate(240,55)"><!-- Gövde eğik --><ellipse cx="0" cy="95" rx="26" ry="32" fill="#FF85A1" transform="rotate(-10,0,95)"/><!-- Etek --><ellipse cx="-4" cy="120" rx="28" ry="10" fill="#FF4081" opacity="0.4"/><!-- Kol sağ uzanmış --><rect x="20" y="88" width="12" height="32" fill="#FDBCB4" rx="6" transform="rotate(40,26,104)"/><!-- Kol sol --><rect x="-36" y="82" width="12" height="24" fill="#FDBCB4" rx="6" transform="rotate(-5,-30,94)"/><!-- Bacaklar --><rect x="-14" y="125" width="11" height="26" fill="#FDBCB4" rx="5"/><rect x="4" y="125" width="11" height="26" fill="#FDBCB4" rx="5"/><!-- Ayakkabılar --><ellipse cx="-8" cy="153" rx="11" ry="5" fill="#FF4081"/><ellipse cx="10" cy="153" rx="11" ry="5" fill="#FF4081"/><!-- Yüz hafif eğik --><circle cx="-4" cy="46" r="26" fill="#FDBCB4"/><!-- Saç --><path d="M-26 34 Q-30 65 -26 96" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><!-- Sol saç --><path d="M18 34 Q22 65 18 96" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><!-- Sağ saç --><path d="M-26 32 Q-4 18 18 32 Q14 54 -4 56 Q-22 54 -26 32Z" fill="#4A2C0A"/><!-- Tokalar --><circle cx="-24" cy="48" r="5" fill="#FF4081"/><circle cx="-24" cy="48" r="2.5" fill="#FFD6E0"/><circle cx="16" cy="48" r="5" fill="#FF4081"/><circle cx="16" cy="48" r="2.5" fill="#FFD6E0"/><!-- Gözler --><ellipse cx="-13" cy="44" rx="5" ry="6" fill="#2C1810"/><ellipse cx="5" cy="44" rx="5" ry="6" fill="#2C1810"/><circle cx="-11" cy="42" r="2" fill="white"/><circle cx="7" cy="42" r="2" fill="white"/><!-- Yanaklar --><circle cx="-19" cy="54" r="7" fill="#FFB3BA" opacity="0.6"/><circle cx="8" cy="55" r="7" fill="#FFB3BA" opacity="0.6"/><!-- Gülümseme --><path d="M-11 62 Q-4 68 3 62" fill="none" stroke="#C0605A" stroke-width="2.5" stroke-linecap="round"/></g><!-- Araba yerde ilerliyor --><g transform="translate(155,183)"><!-- Hareket çizgileri --><line x1="-55" y1="-5" x2="-70" y2="-5" stroke="#FFB300" stroke-width="2" stroke-dasharray="4,3" opacity="0.7"/><line x1="-55" y1="2" x2="-72" y2="2" stroke="#FFB300" stroke-width="2" stroke-dasharray="4,3" opacity="0.6"/><line x1="-55" y1="9" x2="-68" y2="9" stroke="#FFB300" stroke-width="2" stroke-dasharray="4,3" opacity="0.5"/><!-- Araba --><rect x="-34" y="-24" width="68" height="26" fill="#FF3D00" rx="8"/><rect x="-20" y="-36" width="40" height="16" fill="#FF6E40" rx="5"/><rect x="-16" y="-34" width="14" height="10" fill="#B3E5FC" rx="2" opacity="0.9"/><rect x="2" y="-34" width="14" height="10" fill="#B3E5FC" rx="2" opacity="0.9"/><circle cx="-20" cy="4" r="11" fill="#212121"/><circle cx="-20" cy="4" r="5" fill="#616161"/><circle cx="20" cy="4" r="11" fill="#212121"/><circle cx="20" cy="4" r="5" fill="#616161"/><ellipse cx="32" cy="-12" rx="5" ry="4" fill="#FFD740" opacity="0.9"/></g></svg>`,

    /* Sahne 2 — Araba masanın ayağına çarptı */
    2: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 220"><defs><linearGradient id="h1bg2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#FFF9F0"/><stop offset="100%" stop-color="#FFE0CC"/></linearGradient></defs><rect width="400" height="220" fill="url(#h1bg2)"/><rect x="0" y="185" width="400" height="35" fill="#F5C9A0"/><rect x="0" y="182" width="400" height="5" fill="#E8A87C"/><!-- Masa --><rect x="60" y="140" width="160" height="10" fill="#A0522D" rx="3"/><rect x="72" y="150" width="11" height="38" fill="#8B4513" rx="2"/><rect x="200" y="150" width="11" height="38" fill="#8B4513" rx="2"/><!-- Çarpma efekti --><text x="75" y="175" font-size="22" fill="#FFD600" opacity="0.9">💥</text><!-- Araba masanın ayağına çarpmış --><g transform="translate(88,182)"><rect x="-34" y="-24" width="64" height="24" fill="#FF3D00" rx="7"/><rect x="-20" y="-36" width="38" height="14" fill="#FF6E40" rx="5"/><rect x="-16" y="-34" width="12" height="9" fill="#B3E5FC" rx="2" opacity="0.9"/><rect x="0" y="-34" width="12" height="9" fill="#B3E5FC" rx="2" opacity="0.9"/><circle cx="-18" cy="2" r="10" fill="#212121"/><circle cx="-18" cy="2" r="5" fill="#616161"/><circle cx="18" cy="2" r="10" fill="#212121"/><circle cx="18" cy="2" r="5" fill="#616161"/></g><!-- Mina şaşırmış -- ağzı açık --><g transform="translate(280,60)"><!-- Gövde --><ellipse cx="0" cy="95" rx="27" ry="33" fill="#FF85A1"/><!-- Etek --><ellipse cx="0" cy="121" rx="29" ry="10" fill="#FF4081" opacity="0.4"/><!-- Kollar şaşkın açık --><rect x="-40" y="72" width="12" height="26" fill="#FDBCB4" rx="6" transform="rotate(-40,-34,85)"/><!-- Sol kol yukarı --><rect x="28" y="72" width="12" height="26" fill="#FDBCB4" rx="6" transform="rotate(40,34,85)"/><!-- Sağ kol yukarı --><!-- Bacaklar --><rect x="-14" y="126" width="11" height="26" fill="#FDBCB4" rx="5"/><rect x="4" y="126" width="11" height="26" fill="#FDBCB4" rx="5"/><!-- Ayakkabılar --><ellipse cx="-8" cy="154" rx="11" ry="5" fill="#FF4081"/><ellipse cx="10" cy="154" rx="11" ry="5" fill="#FF4081"/><!-- Yüz --><circle cx="0" cy="48" r="26" fill="#FDBCB4"/><!-- Saç --><path d="M-22 36 Q-26 68 -22 98" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><path d="M22 36 Q26 68 22 98" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><path d="M-22 34 Q0 20 22 34 Q18 56 0 58 Q-18 56 -22 34Z" fill="#4A2C0A"/><!-- Tokalar --><circle cx="-20" cy="50" r="5" fill="#FF4081"/><circle cx="-20" cy="50" r="2.5" fill="#FFD6E0"/><circle cx="20" cy="50" r="5" fill="#FF4081"/><circle cx="20" cy="50" r="2.5" fill="#FFD6E0"/><!-- Şaşkın gözler büyük --><ellipse cx="-9" cy="44" rx="7" ry="8" fill="#2C1810"/><!-- Sol göz büyük --><ellipse cx="9" cy="44" rx="7" ry="8" fill="#2C1810"/><!-- Sağ göz büyük --><circle cx="-6" cy="41" r="2.5" fill="white"/><circle cx="12" cy="41" r="2.5" fill="white"/><!-- Kaşlar yukarı --><path d="M-15 33 Q-9 28 -3 33" fill="none" stroke="#4A2C0A" stroke-width="2"/><path d="M3 33 Q9 28 15 33" fill="none" stroke="#4A2C0A" stroke-width="2"/><!-- Yanaklar --><circle cx="-16" cy="56" r="7" fill="#FFB3BA" opacity="0.6"/><circle cx="16" cy="56" r="7" fill="#FFB3BA" opacity="0.6"/><!-- Şaşkın ağız yuvarlak --><circle cx="0" cy="65" r="6" fill="#C0605A"/><!-- Soru işareti --><text x="30" y="20" font-size="18" fill="#FF4081">?</text><text x="46" y="8" font-size="14" fill="#FFB300">!</text></g></svg>`,

    /* Sahne 3 — Mina önce şaşırdı sonra gülmeye başladı */
    3: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 220"><defs><linearGradient id="h1bg3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#FFF0F5"/><stop offset="100%" stop-color="#FFD6E8"/></linearGradient></defs><rect width="400" height="220" fill="url(#h1bg3)"/><rect x="0" y="185" width="400" height="35" fill="#F5C9A0"/><rect x="0" y="182" width="400" height="5" fill="#E8A87C"/><!-- Neşe partikülleri --><text x="30" y="50" font-size="16" fill="#FF85A1">♪</text><text x="350" y="70" font-size="14" fill="#FFD600">★</text><text x="310" y="40" font-size="18" fill="#FF4081">♥</text><text x="70" y="80" font-size="12" fill="#69F0AE">✦</text><!-- Mina kahkaha atıyor --><g transform="translate(200,55)"><!-- Gövde --><ellipse cx="0" cy="95" rx="28" ry="34" fill="#FF85A1"/><!-- Etek --><ellipse cx="0" cy="123" rx="30" ry="11" fill="#FF4081" opacity="0.4"/><!-- Kollar neşeyle yukarı --><rect x="-42" y="68" width="12" height="28" fill="#FDBCB4" rx="6" transform="rotate(-50,-36,82)"/><!-- Sol kol yukarı --><rect x="30" y="68" width="12" height="28" fill="#FDBCB4" rx="6" transform="rotate(50,36,82)"/><!-- Sağ kol yukarı --><!-- Bacaklar --><rect x="-14" y="127" width="11" height="27" fill="#FDBCB4" rx="5"/><rect x="4" y="127" width="11" height="27" fill="#FDBCB4" rx="5"/><!-- Ayakkabılar --><ellipse cx="-8" cy="156" rx="11" ry="5" fill="#FF4081"/><ellipse cx="10" cy="156" rx="11" ry="5" fill="#FF4081"/><!-- Yüz --><circle cx="0" cy="48" r="26" fill="#FDBCB4"/><!-- Saç --><path d="M-22 36 Q-28 70 -24 102" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><path d="M22 36 Q28 70 24 102" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><path d="M-22 34 Q0 20 22 34 Q18 56 0 58 Q-18 56 -22 34Z" fill="#4A2C0A"/><!-- Tokalar --><circle cx="-20" cy="50" r="5" fill="#FF4081"/><circle cx="-20" cy="50" r="2.5" fill="#FFD6E0"/><circle cx="20" cy="50" r="5" fill="#FF4081"/><circle cx="20" cy="50" r="2.5" fill="#FFD6E0"/><!-- Gülen gözler kapalı yaylar --><path d="M-14 42 Q-9 37 -4 42" fill="none" stroke="#2C1810" stroke-width="3" stroke-linecap="round"/><!-- Sol göz gülen --><path d="M4 42 Q9 37 14 42" fill="none" stroke="#2C1810" stroke-width="3" stroke-linecap="round"/><!-- Sağ göz gülen --><!-- Yanaklar kırmızı --><circle cx="-15" cy="56" r="9" fill="#FF6B8A" opacity="0.55"/><!-- Sol yanak kırmızı --><circle cx="15" cy="56" r="9" fill="#FF6B8A" opacity="0.55"/><!-- Sağ yanak --><!-- Büyük gülümseme --><path d="M-12 62 Q0 76 12 62" fill="none" stroke="#C0605A" stroke-width="3" stroke-linecap="round"/><!-- Diş --><rect x="-7" y="63" width="14" height="6" fill="white" rx="2"/><!-- Ha ha ha --><text x="38" y="30" font-size="13" fill="#FF4081" font-family="sans-serif" font-weight="bold">Ha ha!</text></g><!-- Araba kenarda duruyor --><g transform="translate(95,185)"><rect x="-34" y="-24" width="68" height="24" fill="#FF3D00" rx="7"/><rect x="-20" y="-36" width="40" height="14" fill="#FF6E40" rx="5"/><rect x="-16" y="-34" width="14" height="9" fill="#B3E5FC" rx="2" opacity="0.8"/><rect x="2" y="-34" width="14" height="9" fill="#B3E5FC" rx="2" opacity="0.8"/><circle cx="-18" cy="2" r="10" fill="#212121"/><circle cx="-18" cy="2" r="5" fill="#616161"/><circle cx="18" cy="2" r="10" fill="#212121"/><circle cx="18" cy="2" r="5" fill="#616161"/></g></svg>`,

    /* Sahne 4 — Arabasını dikkatli sürmesi gerektiğini anladı */
    4: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 220"><defs><linearGradient id="h1bg4" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#FFF9F0"/><stop offset="100%" stop-color="#FFE0CC"/></linearGradient></defs><rect width="400" height="220" fill="url(#h1bg4)"/><rect x="0" y="185" width="400" height="35" fill="#F5C9A0"/><rect x="0" y="182" width="400" height="5" fill="#E8A87C"/><!-- Arka plan dekor --><text x="340" y="50" font-size="14" fill="#FFD600" opacity="0.7">★</text><text x="50" y="40" font-size="12" fill="#FF85A1" opacity="0.6">♥</text><!-- Masa --><rect x="240" y="145" width="130" height="10" fill="#A0522D" rx="3"/><rect x="252" y="155" width="11" height="35" fill="#8B4513" rx="2"/><rect x="349" y="155" width="11" height="35" fill="#8B4513" rx="2"/><!-- Araba masada dikkatli duruyor --><g transform="translate(305,143)"><rect x="-28" y="-20" width="56" height="22" fill="#FF3D00" rx="7"/><rect x="-16" y="-30" width="32" height="13" fill="#FF6E40" rx="4"/><rect x="-13" y="-28" width="11" height="8" fill="#B3E5FC" rx="2" opacity="0.9"/><rect x="2" y="-28" width="11" height="8" fill="#B3E5FC" rx="2" opacity="0.9"/><circle cx="-14" cy="4" r="8" fill="#212121"/><circle cx="-14" cy="4" r="4" fill="#616161"/><circle cx="14" cy="4" r="8" fill="#212121"/><circle cx="14" cy="4" r="4" fill="#616161"/><ellipse cx="26" cy="-8" rx="4" ry="3" fill="#FFD740" opacity="0.9"/></g><!-- Mina düşünceli parmak dudağında --><g transform="translate(160,58)"><!-- Gövde --><ellipse cx="0" cy="95" rx="27" ry="33" fill="#FF85A1"/><!-- Etek --><ellipse cx="0" cy="121" rx="29" ry="10" fill="#FF4081" opacity="0.4"/><!-- Kol sol göğüste --><rect x="-30" y="80" width="12" height="24" fill="#FDBCB4" rx="6" transform="rotate(15,-24,92)"/><!-- Kol sağ — parmak çenede --><rect x="18" y="74" width="12" height="22" fill="#FDBCB4" rx="6" transform="rotate(-20,24,85)"/><!-- Bacaklar --><rect x="-14" y="126" width="11" height="27" fill="#FDBCB4" rx="5"/><rect x="4" y="126" width="11" height="27" fill="#FDBCB4" rx="5"/><!-- Ayakkabılar --><ellipse cx="-8" cy="155" rx="11" ry="5" fill="#FF4081"/><ellipse cx="10" cy="155" rx="11" ry="5" fill="#FF4081"/><!-- Yüz --><circle cx="0" cy="48" r="26" fill="#FDBCB4"/><!-- Saç --><path d="M-22 36 Q-26 70 -22 100" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><path d="M22 36 Q26 70 22 100" fill="none" stroke="#3D1F0A" stroke-width="9" stroke-linecap="round"/><path d="M-22 34 Q0 20 22 34 Q18 56 0 58 Q-18 56 -22 34Z" fill="#4A2C0A"/><!-- Tokalar --><circle cx="-20" cy="50" r="5" fill="#FF4081"/><circle cx="-20" cy="50" r="2.5" fill="#FFD6E0"/><circle cx="20" cy="50" r="5" fill="#FF4081"/><circle cx="20" cy="50" r="2.5" fill="#FFD6E0"/><!-- Gözler düşünceli --><ellipse cx="-9" cy="45" rx="5" ry="5.5" fill="#2C1810"/><ellipse cx="9" cy="45" rx="5" ry="5.5" fill="#2C1810"/><circle cx="-7" cy="43" r="1.8" fill="white"/><circle cx="11" cy="43" r="1.8" fill="white"/><!-- Kaş düşünceli --><path d="M-14 35 Q-8 31 -3 35" fill="none" stroke="#4A2C0A" stroke-width="1.8"/><path d="M3 35 Q9 31 14 35" fill="none" stroke="#4A2C0A" stroke-width="1.8"/><!-- Yanaklar --><circle cx="-15" cy="57" r="7" fill="#FFB3BA" opacity="0.5"/><circle cx="15" cy="57" r="7" fill="#FFB3BA" opacity="0.5"/><!-- Hafif gülümseme --><path d="M-6 63 Q0 68 6 63" fill="none" stroke="#C0605A" stroke-width="2.5" stroke-linecap="round"/><!-- Düşünce balonu --><ellipse cx="60" cy="10" rx="42" ry="22" fill="white" stroke="#FFB3BA" stroke-width="2"/><circle cx="28" cy="24" r="5" fill="white" stroke="#FFB3BA" stroke-width="1.5"/><circle cx="18" cy="32" r="3" fill="white" stroke="#FFB3BA" stroke-width="1.5"/><!-- Balon içi araba simgesi --><text x="32" y="17" font-size="18">🚗</text><text x="56" y="15" font-size="14" fill="#4CAF50">✓</text></g></svg>`
  },
